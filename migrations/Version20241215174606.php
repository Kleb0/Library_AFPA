 ...
 */
final class Version20241215174606 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book_comment (book_id INT NOT NULL, comment_id INT NOT NULL, INDEX IDX_7547AFAF8697D13 (comment_id), INDEX IDX_7547AFA16A2B381 (book_id), PRIMARY KEY(book_id, comment_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
