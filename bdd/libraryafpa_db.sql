...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 16 déc. 2024 à 05:25
...
INSERT INTO `borrow_history` (`id`, `user_id`, `borrowed_at`, `returned_at`) VALUES
(59, 1, '2024-12-16 05:07:59', '2024-12-22 05:07:59'),
(60, 1, '2024-12-16 05:15:01', '2024-12-22 05:15:01');
...
--
-- Déchargement des données de la table `borrow_history_book`
--

INSERT INTO `borrow_history_book` (`borrow_history_id`, `book_id`) VALUES
(59, 23),
(60, 19);
...
--
-- Déchargement des données de la table `reserved_room`
--

INSERT INTO `reserved_room` (`user_id`, `work_room_id`) VALUES
(1, 18);
...
(1, 'Miermont', 'Clément', '1995-03-21', 'clementmiermontei@outlook.com', '$2y$13$7ipdVVwgCbJL9dNHbi6oEOi2M3sEFWaGsJV/Boz1FBaF3Q/IZXYvG', '39 Rue de Hesques', '59300', 'VALENCIENNES', '0661297835', 'cartman-675b31e2a25b1.png', 'Admin', 2),
...
(18, 5, '[\"Wi-Fi\",\"Projecteur\",\"Tableau blanc\",\"Prises \\u00e9lectriques\",\"TV\",\"Air conditionn\\u00e9\"]', '10:00:00', '17:00:00', '2024-12-16', '2025-09-16', 'Dimanche', 1, 0),
(20, 4, '[\"Wi-Fi\",\"Projecteur\",\"Tableau blanc\",\"Prises \\u00e9lectriques\",\"TV\",\"Air conditionn\\u00e9\"]', '10:00:00', '17:00:00', '2024-12-18', '2024-12-20', 'Dimanche', 2, 1);
